...
<template>
  ...
  <div v-else class="flex flex-col gap-8">
    ...
    <Modal v-model="showDetails" :title="expansion.name">
      <div class="flex flex-col gap-10">
        <header class="flex flex-col sm:flex-row sm:items-center gap-6">
          <div class="w-full sm:w-56 aspect-16/9 bg-ink-950 border border-ink-700 rounded-xl flex items-center justify-center p-4 shrink-0">
